...
public abstract class Person implements java.io.Serializable {
			...
			Date DOB, String Address, String Phone_number, String Email) throws PersonException
	{
		...
		Date Hundreds= new Date(1918, 1, 1);
		if (DOB.before(Hundreds)) {
			throw new PersonException(this, "Can't be older than 100 years");
		}
		...
		if(matcher.matches()) {
			...
			throw new PersonException(this, "Phone number isn't formatted correctly");
		}
	}
